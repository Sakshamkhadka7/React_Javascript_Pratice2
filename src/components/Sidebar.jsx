...
// Here we have used selected and setSelected logic now we have router logic
const Sidebar = () => {
  ...
  <ul className="nav nav-pills flex-column mb-auto">
    ...
    // onClick={()=>{  console.log("Home button is clicked") }}
    ...
    <li
    //  onClick={()=>{  console.log("Create Post button is Clicked") }}
